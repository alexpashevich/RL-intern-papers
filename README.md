...
A curated list of papers dedicated to reinforcement learning which can be useful during the internship. The document consists of four sections from specific papers about grasping to general RL papers. Each section consists of brief summaries of several papers on the topic. In each section papers are given in the chronological order. Some of the papers which in my opinion deserve to be studied carefully, are marked as **[highlight]**.
